...
# Change this if your default location is not Yogyakarta/YIA.
DEFAULT_ORIGIN_IATA = os.getenv("DEFAULT_ORIGIN_IATA", "YIA")
...
if __name__ == "__main__":
    print(search_flights("Rencanakan perjalanan 7 hari ke Jepang dari Yogyakarta"))
    print("\n" + "=" * 80 + "\n")
